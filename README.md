...
#### Na codificação:
Vale lembrar que, ao inserirmos a mensagem no campo de texto e apertar o botão de codificar a aplicação vai percorrer pelo o texto a procura de vogais para poder substituir por alguns caracteres pré-determinados, como:
- "a" vai substituir por "ai"
- "e" vai substituir por "enter"
- "i" vai substituir por "imes"
- "o" vai substituir por "ober"
- "u" vai substituir por "ufat"
#### Na decodificação:
...
---
Criado com por: [<img src="https://avatars.githubusercontent.com/u/81197504?v=4" width=115><br><sub>Isabella Barros</sub>](https://github.com/Isabellabarroos)
